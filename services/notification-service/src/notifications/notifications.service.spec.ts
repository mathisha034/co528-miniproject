...
describe('NotificationsService', () => {
    ...
    describe('create — idempotency', () => {
        ...
        it('should create notification when key is new', async () => {
            ...
            mockNotificationModel.create.mockResolvedValue({ ...baseDto, _id: VALID_ID2 });
    ...
    describe('create — retry', () => {
        ...
        it('should throw after 3 failed attempts', async () => {
            mockNotificationModel.findOne.mockRejectedValue(new Error('persistent DB error'));
            await expect(
                service.create({
                    userId: VALID_ID,
                    type: NotificationType.GENERAL,
    ...
    describe('findForUser', () => {
        it('should return all notifications for a user', async () => {
            ...
            mockNotificationModel.find.mockReturnValue({ sort: () => ({ exec: fakeExec }) });
