...
export class JobsService {
    ...
    async updateStatus(id: string, dto: UpdateJobStatusDto): Promise<JobDocument> {
    ...
    async apply(jobId: string, applicantId: string, dto: CreateApplicationDto): Promise<ApplicationDocument> {
    ...
    async updateApplicationStatus(
        ...
        const app = await this.appModel.findOne({ _id: appId, jobId: new Types.ObjectId(jobId) });
